    ...
    <>
      <Container maxWidth="md">
        <Typography variant="h6" gutterBottom>
          Staff Management: SeniorStaff
        </Typography>

        <Box component="form" onSubmit={handleSubmit} sx={{}} id="seniorForm">
...
<BorderedSection title="Recall">
  <Container maxWidth="sm">
    <Stack direction="row" spacing={3}>
      <Button
        component={Link}
        to={`/staff-management/senior/suspended-staff`}
        variant="contained"
        color="success"
      >
        Suspended Staff
      ...
      <Button
        component={Link}
        to={`/staff-management/senior/retrenched-staff`}
        variant="contained"
        color="success"
      >
        Retrenched Staff
